    ...
    <div className="bg-white px-[20px] lg:px-[120px] py-8">
        ...
        <div className="w-[80%] lg:w-1/4 border border-gray-300 rounded-lg shadow-md">
          ...
          <div className="bg-[#f7f7f7] rounded-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <img src="silver.png" alt=" Silver Image" className="w-17  h-12 mr-4" />
            </div>
          ...
          <div className="bg-[#f0f0f0] rounded-b-lg p-6 border-t border-gray-300 flex justify-between items-center">
            <p className="text-sm text-gray-700">
              Starting from
              <br />
              <span className="font-bold text-lg">40 TND</span>/month
            </p>
            <button className="bg-elements text-white px-6 py-3 rounded-full hover:bg-[#6C871B] focus:outline-none">Subscribe</button>
          </div>
        </div>
        <div className="w-[80%] lg:w-1/4 border border-gray-300 rounded-lg shadow-md">
          {/* Gold Plan */}
          ...
          <div className="bg-[#f0f0f0] rounded-b-lg p-6 border-t border-gray-300 flex justify-between items-center">
            <p className="text-sm text-gray-700">
              Starting from
              <br />
              <span className="font-bold text-lg">60 TND</span>/month
            </p>
            <button className="bg-elements text-white px-6 py-3 rounded-full hover:bg-[#6C871B] focus:outline-none">Subscribe</button>
          </div>
        </div>
      ...
      {/* Additional card */}
        <div className="w-full lg:w-1/2 border border-gray-300 rounded-lg shadow-md mt-8 mx-auto">
          <div className="bg-[#f7f7f7] rounded-lg p-6 flex items-start"> {/* Change items-center to items-start */}
            {/* Logo */}
            <img src="logo.png" alt="Logo" className="w-16 h-16 rounded-full bg-gray-300 mr-4" style={{ alignSelf: 'flex-start' }} /> {/* Add style={{ alignSelf: 'flex-start' }} */}

            {/* Content */}
            <div>
              <h2 className="text-lg font-bold mb-4">LUNGUIFY MiniLesson</h2>
              <div className="flex items-center mb-6"> {/* Wrap text and button inside a flex container */}
                <p className="text-base text-gray-600 mr-4">Practice speaking English with LUNGUIFY AI for free today!</p> {/* Add mr-4 for margin */}
                <button className="bg-elements text-white px-6 py-3 rounded-full hover:bg-[#6C871B] focus:outline-none">Explore</button>
              </div>
            </div>
          </div>
        </div>
