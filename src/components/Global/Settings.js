        ...
        <div className="w-full overflow-y-auto flex flex-col m-auto space-y-7 h-[90%] px-2 sm:px-15 lg:px-28 py-7">
           ...
           <div className="flex flex-wrap gap-5 items-center justify-center ">
            ...
            <div className="justify-center flex flex-col items-center  space-y-3">
                ...
                <div className="px-4 cursor-pointer py-3 bg-errortext hover:border hover:border-errortext hover:bg-errorbg hover:text-errortext transition-colors duration-200 text-white rounded-md">Click here</div>
            </div>
        </div>
    );
}
