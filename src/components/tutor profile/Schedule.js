...
import {resetData, setSteps} from '../../state/slices/Schedule'
...
function Schedule(props) {
    ...
    const content = [
        <FirstStep times={times} moveForward={handleNavigateForward} moveBackwards={handleNavigateBack}></FirstStep>,
        <SecondStep moveForward= {handleNavigateForward} moveBackwards={handleNavigateBack} ></SecondStep>,
        <ThirdStep moveBackwards={handleNavigateBack}></ThirdStep>
    ]
