...
function StudyBuddyCard(props) {
    const content = [
        ...
        <button className="border border-button text-button rounded-2xl h-10 bg-lightbutton flex justify-center items-center text-sm font-bold w-full">Make StudyPals</button>
    ]
    return (
